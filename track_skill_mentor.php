...
<body>
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<h2 style='color: white; text-align: center; margin-top:30px;'>TRACK SKILL OF YOUR MENTEE</h2>";

            echo "<div class='mentee-container'>";
            // output data of each row
            while($row = $result->fetch_assoc()) {
                echo "<div class='mentee-box' onclick='location.href=\"track_skill_mentor_1.php?uname=" . $row["uname"] . "\"'>
